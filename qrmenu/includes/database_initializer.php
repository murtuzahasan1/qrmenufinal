        ...
        $roles = [
            ...
            [
                ...
                'permissions' => json_encode([
                    'manage_restaurant', 'manage_branches', 'manage_menu', 
                    'manage_orders', 'manage_staff', 'view_reports'
                ])
            ],
            [
                'name' => 'manager',
                ...
                'permissions' => json_encode([
                    'manage_branches', 'manage_menu', 'manage_orders', 
            ...
            [
                ...
                'permissions' => json_encode([
                    'manage_menu', 'manage_orders', 'manage_staff', 'view_reports'
                ])
            ],
            [
                'name' => 'chef',
                'description' => 'Chef',
                'permissions' => json_encode([
                    'view_menu', 'manage_orders', 'view_reports'
                ])
            ],
            [
                'name' => 'waiter',
